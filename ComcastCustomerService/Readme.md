...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *ComcastCustomerService*):

Restore dependencies
```
    cd "ComcastCustomerService"
    dotnet restore
```

Execute unit tests
```
    cd "ComcastCustomerService/test/ComcastCustomerService.Tests"
    dotnet test
```

Deploy application
```
    cd "ComcastCustomerService/src/ComcastCustomerService"
